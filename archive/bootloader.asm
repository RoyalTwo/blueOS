;
;
;   This was a custom bootloader. I wrote it so I could learn how a bootloader works and now that I have (for the most part),
;   I have switched to a multiboot compliant boot process that uses GRUB, so I can focus more on the kernel and other parts.
;   Using a multiboot compliant system also makes it more agnostic and similar to a real OS.
;
;
